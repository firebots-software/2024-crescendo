 ...
 * PLEASE NOTE THAT THIS FILE HAS TO BE IN THIS LOCATION. IF NOT, THERE WILL BE ISSUES WITH CERTAIN ASPECTS OF THE CODE.
 */
 ...
 */
public class SwerveDrivetrainNavX {
  ...
  public SwerveDrivetrainNavX(
    ...
    m_pigeon2 = new Pigeon2(0);
    gyro = new AHRS();
    m_pigeon2.getYaw();
    m_yawGetter = new StatusSignal<Double>(new DeviceIdentifier(), 0, new Runnable(gyro.getAngle),
    Double.class,
    new MapGenerator<Double>(), "AHRS");
    // m_yawGetter.getValue();
