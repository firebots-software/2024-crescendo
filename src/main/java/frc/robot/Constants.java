...
public final class Constants {
  ...
  public static final class Arm {
    ...
    public static final double MOTIONMAGIC_KV = 50; // MotionMagic Cruise Velocity in RPS of the arm
    public static final double MOTIONMAGIC_KA = 155; // MotionMagic Acceleration in RPS^2 of the arm
