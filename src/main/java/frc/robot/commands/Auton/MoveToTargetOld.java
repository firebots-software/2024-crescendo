...
// public class MoveToTargetOld extends Command {
...
//   private MoveToTargetOld(SwerveSubsystem swerve, Pose2d absolutePose, Supplier<Boolean> reflected) {
...
//     return new MoveToTargetOld(swerve, absolutePose, () -> false);
//   }

//   public static Command withMirror(
//       SwerveSubsystem swerve, Supplier<Boolean> mirror, Pose2d... absolutePose) {
//     return new MoveToTargetOld(swerve, absolutePose, mirror);
//   }
// }
