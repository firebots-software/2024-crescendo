...
public class ArmSubsystem extends SubsystemBase {
  ...
  public ArmSubsystem() {
    ...
    CurrentLimitsConfigs clc =
        new CurrentLimitsConfigs().withStatorCurrentLimitEnable(true).withStatorCurrentLimit(Constants.Arm.ARM_STATOR_CURRENT_LIMIT_AMPS).withSupplyCurrentLimit(Constants.Arm.CURRENT_LIMIT);
