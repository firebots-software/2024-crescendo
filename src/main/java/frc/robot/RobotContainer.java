...
import frc.robot.commands.ArmCommands.ArmToClimbCmd;
import frc.robot.commands.ArmCommands.ArmToFinishClimbCmd;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // arm to climb pos (90 degrees)
    joystickB
     .x().whileTrue(swerveJoystickCommand);

     //arm to lock in (15 degrees) 
     joystickB
     .y().whileTrue(getAutonomousCommand());
  }
