...
public class RobotContainer {
  ...
  private final MoveToTarget targetMove = new MoveToTarget(driveTrain, new Pose2d(3, 4, Rotation2d.fromDegrees(180)));
  ...
  private void configureBindings() {
    ...
    // zero-heading
    joystick.circle().onTrue(driveTrain.runOnce(() -> driveTrain.seedFieldRelative(new Pose2d(new Translation2d(0.5, 0), new Rotation2d(0)))));
    joystick.square().onTrue(targetMove);
